...
def get_mag(q,tau):
    ...
    Parameters:
        q (numpy.ndarray): Orientation quaternion [qw, qx, qy, qz]
        tau (float): Thrust generated by the drone # TODO: Add the influence of current instead
    """

    # Local Earth magnetic field in ENU frame
...
def get_gps(p,vw):
    ...
    gps['i_vel__cm/s'] = 65535 #( sqrt(vw[0]**2+vw[1]**2)*0 + random()*0.001 )*100    # GPS ground speed. If unknown, set to: 65535 [cm/s] (type:uint16_t)
